...
- [databricks-fm-bestbuy-retail-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-bestbuy-retail-intelligence) - Syncs Best Buy product catalog with AI-powered retail analytics: competitive positioning, price optimization, and sentiment analysis using Databricks ai_query().
